...
from Knight_EZ import *
from Archer_EZ import *
from Wizard_EZ import *
...
def run():
    ...
    blue_knight = Knight_EZ(world, blue_knight_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_archer = Archer_EZ(world, blue_archer_image, blue_arrow_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_wizard = Wizard_EZ(world, blue_wizard_image, blue_rock_image, blue_base, Vector2(blue_base.spawn_position), blue_explosion_image)
